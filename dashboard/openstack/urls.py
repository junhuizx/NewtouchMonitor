...
urlpatterns = [
    ...
    url(r'^hypervisors/(?P<pk>\d+)/$', views.OpenStackHypervisorsView.as_view(),name='openstack_hypervisors'),
    url(r'^hypervisors/(?P<pk>\d+)/(?P<hypervisor_hostname>\w+)/$', views.OpenStackHypervisorDetailView.as_view(), name='openstack_hypervisors_detail'),
